...
module.exports = {
    ...
    findHookDependencies(nodePackage, searchPaths) {
        // If we've been given a non-node package, or the package contains no dependencies, simply return an empty array.
        if (!(nodePackage instanceof Object) || !(nodePackage.dependencies instanceof Object)) {
            return [];
        }
        ...
        Object.keys(nodePackage.dependencies).forEach(depName => {
            ...
            const hookName = (typeof pkg.sails.hookName === 'string') ? pkg.sails.hookName : depName;
